...
public class Menu {
    ...
    public void imprimirConversiones(ArrayList<Cambiador> listaDeConversiones) {
        if (listaDeConversiones.isEmpty()) {
            ...
            for (int i = 0; i < listaDeConversiones.size(); i++) {
                Cambiador cambiador = listaDeConversiones.get(i);
                System.out.println("Conversión " + (i + 1) + ":");
                System.out.println("Moneda origen: " + cambiador.getMonedaBase());
                System.out.println("Moneda objetivo: " + cambiador.getMonedaObjetivo());
                System.out.println("Cantidad a cambiar: " + cambiador.getCantidadACambiar());
                System.out.println("Cantidad obtenida: " + cambiador.getCantidadEnMonedaObjetivo());
                System.out.println("Fecha y hora: " + formatDateTime(cambiador.getTiempo()));
                System.out.println("-----------------------------------------");
            }
        }
    }
